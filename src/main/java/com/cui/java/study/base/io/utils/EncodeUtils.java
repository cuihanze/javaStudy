...
public class EncodeUtils {
    ...
    public static void main(String[] args) throws Exception {
        Reader in = null;
        try {
            String filePath = "/Users/cuihanze/Downloads/B端限时购测试副本 4.csv";
            BufferedInputStream bis = new BufferedInputStream(new FileInputStream(filePath));
            String encode = getEncode(bis, false);
            in = new InputStreamReader(bis, encode);
    ...
    public static void convert(String oldFullFileName, String oldCharsetName, String newFullFileName, String newCharsetName) throws Exception {
        ...
        @Cleanup Writer out = new OutputStreamWriter(new FileOutputStream(newFullFileName), newCharsetName);
